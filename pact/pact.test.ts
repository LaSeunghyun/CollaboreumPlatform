...
describe('API Contract Tests', () => {
    ...
    describe('Community API', () => {
        it('GET /api/community/posts returns posts list', async () => {
            ...
            const response = await fetch(`${provider.mockService.baseUrl}/api/community/posts?page=1&limit=10`);
            expect(response.status).toBe(200);
            const data = await response.json();
            expect(data.success).toBe(true);
    ...
    describe('Projects API', () => {
        it('GET /api/projects returns projects list', async () => {
            ...
            const response = await fetch(`${provider.mockService.baseUrl}/api/projects?page=1&limit=10`);
            expect(response.status).toBe(200);
            const data = await response.json();
            expect(data.success).toBe(true);
    ...
    describe('Search API', () => {
        it('GET /api/search returns search results', async () => {
            ...
            const response = await fetch(`${provider.mockService.baseUrl}/api/search?query=test&type=all`);
            expect(response.status).toBe(200);
            const data = await response.json();
            expect(data.success).toBe(true);
