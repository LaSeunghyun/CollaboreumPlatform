...
const createUserFromArgs = () => {
  ...
  if (args.length < 3) {
    console.log('📝 사용법: node quick-user.js <이름> <이메일> <비밀번호> [역할] [자기소개]');
    console.log('📝 예시: node quick-user.js "홍길동" "hong@example.com" "password123" "artist" "음악가입니다"');
