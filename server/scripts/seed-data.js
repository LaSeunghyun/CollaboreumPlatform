    ...
    const projects = [
      {
        title: '첫 번째 앨범 제작',
        description:
          '인디 록 밴드의 첫 번째 정규 앨범을 제작하는 프로젝트입니다. 다양한 장르의 음악을 담아내며, 독창적인 사운드를 만들어내는 것이 목표입니다.',
        artist: users[0]._id,
      ...
      },
      {
        title: '현대미술 전시회',
        description:
          '추상화와 현대미술 작품들을 전시하는 갤러리 전시회를 기획하고 진행하는 프로젝트입니다.',
        artist: users[1]._id,
    ...
    const fundingProjects = [
      {
        title: '인디 록 앨범 제작 펀딩',
        description:
          '독립적인 사운드와 메시지를 담은 인디 록 앨범을 제작하기 위한 펀딩 프로젝트입니다.',
        artist: users[0]._id,
        artistName: users[0].name,
        category: '음악',
        goalAmount: 10000000,
      ...
      },
      {
        title: '현대미술 작품집 출판',
        description:
          '현대미술 작품들을 담은 고품질 작품집을 출판하는 펀딩 프로젝트입니다.',
        artist: users[1]._id,
        artistName: users[1].name,
        category: '도서',
        goalAmount: 5000000,
    ...
    const posts = [
      {
        title: '인디 음악의 매력에 대해',
        content:
          '최근에 다양한 인디 음악을 듣고 있는데, 정말 매력적이네요. 특히 독창적인 사운드와 진정성 있는 가사가 인상적입니다. 여러분도 좋아하는 인디 아티스트가 있나요?',
        author: users[2]._id,
      ...
      },
      {
        title: '현대미술 전시회 후기',
        content:
          '지난 주에 현대미술 전시회를 다녀왔는데, 정말 감동적이었습니다. 추상화의 아름다움을 새롭게 발견할 수 있었어요. 비슷한 전시회를 추천받고 싶습니다.',
        author: users[3]._id,
      ...
      },
      {
        title: '아티스트 지원 방법',
        content:
          '독립 아티스트들을 지원하고 싶은데, 어떤 방법들이 있을까요? 펀딩 참여, SNS 홍보, 직접 연락 등 다양한 방법이 있다고 들었습니다. 경험이 있으신 분들의 조언을 부탁드려요.',
        author: users[2]._id,
        authorName: users[2].name,
        category: '기타',
        tags: ['아티스트', '지원', '조언'],
    ...
    const liveStreams = [
      {
        title: '인디 록 라이브 공연',
        description:
          '새로운 곡들을 선보이는 인디 록 밴드의 라이브 공연입니다. 팬들과 함께하는 특별한 시간이 될 예정입니다.',
        artist: users[0]._id,
        artistName: users[0].name,
        category: '음악',
      ...
      },
      {
        title: '현대미술 작품 제작 과정',
        description:
          '현대미술 작가가 작품을 제작하는 과정을 실시간으로 보여주는 라이브 스트림입니다.',
        artist: users[1]._id,
        artistName: users[1].name,
        category: '공연',
      ...
      },
      {
        title: '음악 이론 강의',
        description:
          '기초 음악 이론부터 고급 테크닉까지 배울 수 있는 교육용 라이브 스트림입니다.',
        artist: users[0]._id,
        artistName: users[0].name,
        category: '워크샵',
    ...
    const events = [
      {
        ...
        description:
          '다양한 인디 아티스트들이 참여하는 대규모 음악 페스티벌입니다. 새로운 사운드와 재능을 발견할 수 있는 특별한 기회입니다.',
        category: '축제',
      ...
      },
      {
        title: '현대미술 전시회 개막식',
        description:
          '신진 작가들의 현대미술 작품을 전시하는 갤러리 전시회입니다. 작가와의 만남도 함께 진행됩니다.',
        category: '공연',
      ...
      },
      {
        title: '음악 제작 워크샵',
        description:
          '프로 음악 제작자가 직접 가르치는 음악 제작 워크샵입니다. 실습 위주의 교육으로 구성되어 있습니다.',
        category: '워크샵',
