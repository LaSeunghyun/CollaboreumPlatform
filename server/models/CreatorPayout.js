...
creatorPayoutSchema.methods.markAsCompleted = function (
  bankTransactionId,
  bankResponseCode,
  bankResponseMessage,
) {
...
creatorPayoutSchema.methods.markAsFailed = function (
  reason,
  bankResponseCode,
  bankResponseMessage,
) {
...
// 정적 메서드
creatorPayoutSchema.statics.getCreatorPayoutStats = function (
  creatorId,
  startDate,
  endDate,
) {
