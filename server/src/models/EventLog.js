...
const eventLogSchema = new Schema({
  ...
  aggregateType: {
    ...
    enum: {
      values: ['funding_project', 'pledge', 'execution', 'distribution', 'payment'],
...
eventLogSchema.statics.findByAggregate = function(aggregateId, aggregateType = null) {
...
eventLogSchema.statics.findCompleted = function(startDate = null, endDate = null) {
