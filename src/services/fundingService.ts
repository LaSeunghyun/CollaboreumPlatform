...
export const fundingService = {
    ...
    getFollowingArtistsFundingHistory: async (
        ...
        try {
            const response = await apiCall<ApiResponse<ArtistFundingHistory[]>>(`/users/${userId}/following/funding-history`, {
                method: 'POST',
            ...
            throw new Error(response.message || '펀딩 히스토리를 가져오는데 실패했습니다.');
        } catch (error) {
    ...
    getArtistFundingHistory: async (
        ...
        try {
            const response = await apiCall<ApiResponse<ArtistFundingHistory>>(`/users/${userId}/following/${artistId}/funding-history`, {
                method: 'POST',
                body: JSON.stringify(filter)
            });
            ...
            throw new Error(response.message || '아티스트 펀딩 히스토리를 가져오는데 실패했습니다.');
        } catch (error) {
    ...
    getProjectDetails: async (projectId: string): Promise<FundingProject> => {
        try {
            ...
            throw new Error(response.message || '프로젝트 상세 정보를 가져오는데 실패했습니다.');
        } catch (error) {
    ...
    getProjectUpdates: async (projectId: string): Promise<ProjectUpdate[]> => {
        try {
            ...
            throw new Error(response.message || '프로젝트 업데이트를 가져오는데 실패했습니다.');
        } catch (error) {
    ...
    getProjectBackers: async (projectId: string): Promise<ProjectBacker[]> => {
        try {
            ...
            throw new Error(response.message || '후원자 목록을 가져오는데 실패했습니다.');
        } catch (error) {
