...
describe('Community Board System', () => {
  ...
  describe('Community Post List', () => {
    test('게시글 목록이 올바르게 렌더링되어야 한다', () => {
      const mockPosts = [
        mockCommunityPost,
        { ...mockCommunityPost, id: '2', title: '두 번째 게시글' },
      ];
        ...
        <BrowserRouter>
          <div data-testid='post-detail'>
            ...
            <div data-testid='post-meta'>
              ...
              <span>
                작성일:{' '}
                {new Date(mockCommunityPost.createdAt).toLocaleDateString()}
              </span>
        ...
        <BrowserRouter>
          <div data-testid='post-detail'>
            <button data-testid='like-button'>
              👍 {mockCommunityPost.likes}
            </button>
            <button data-testid='dislike-button'>
              👎 {mockCommunityPost.dislikes}
            </button>
          </div>
        </BrowserRouter>,
      );
        ...
        <BrowserRouter>
          <div data-testid='comments-section'>
            <div data-testid='comment-1'>
              ...
              <span>
                {new Date(mockComment.createdAt).toLocaleDateString()}
              </span>
              <button data-testid='like-comment-1'>
                👍 {mockComment.likes}
              </button>
            </div>
          </div>
        ...
        <BrowserRouter>
          <div data-testid='post-detail'>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: maliciousPost.content }}
            ></div>
          </div>
        </BrowserRouter>,
      );
        ...
        <BrowserRouter>
          <div data-testid='post-edit-form'>
            ...
            <textarea
              ...
              defaultValue={originalPost.content}
            />
