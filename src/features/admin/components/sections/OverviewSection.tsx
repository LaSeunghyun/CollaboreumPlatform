        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{metrics?.userMetrics?.totalUsers || 0}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{metrics?.userMetrics?.activeArtists || 0}</div>
                        <p className="text-xs text-muted-foreground">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {metrics?.fundingMetrics?.totalFundedAmount?.toLocaleString() || 0}원
                        </div>
                        <p className="text-xs text-muted-foreground">
