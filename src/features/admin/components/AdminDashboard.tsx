...
const UserManagementSection = lazy(() =>
  import('./sections/UserManagementSection').then(m => ({
    default: m.UserManagementSection,
  })),
);
const FundingManagementSection = lazy(() =>
  import('./sections/FundingManagementSection').then(m => ({
    default: m.FundingManagementSection,
  })),
);
const CommunityManagementSection = lazy(() =>
  import('./sections/CommunityManagementSection').then(m => ({
    default: m.CommunityManagementSection,
  })),
);
const ArtworkManagementSection = lazy(() =>
  import('./sections/ArtworkManagementSection').then(m => ({
    default: m.ArtworkManagementSection,
  })),
);
const FinanceManagementSection = lazy(() =>
  import('./sections/FinanceManagementSection').then(m => ({
    default: m.FinanceManagementSection,
  })),
);
const AnalyticsSection = lazy(() =>
  import('./sections/AnalyticsSection').then(m => ({
