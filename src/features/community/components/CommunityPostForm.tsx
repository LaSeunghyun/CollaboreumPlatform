...
export function CommunityPostForm({
    ...
    const {
        ...
        defaultValues: {
            ...
            tags: initialData?.tags ? (Array.isArray(initialData.tags) ? initialData.tags.join(', ') : String(initialData.tags)) : '' as any,
    ...
    const onSubmit = async (data: PostFormData) => {
        ...
        try {
            ...
            const errorMessage = error?.message || '게시글 저장에 실패했습니다. 다시 시도해주세요.'
            ...
            return (
                <Card>
                    <CardContent className="p-6 text-center">
                        <p className="text-neutral-600 mb-4">로그인이 필요합니다.</p>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit(onSubmit as any)} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {errors.title && (
                                <p id="title-error" className="text-sm text-danger-600" role="alert">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {errors.content && (
                                <p id="content-error" className="text-sm text-danger-600" role="alert">
