    ...
    switch (currentStep) {
              ...
              <div className='space-y-3'>
                ...
                <div className='grid grid-cols-2 gap-3'>
                  {[1000, 5000, 10000, 50000, 100000].map(amount => (
                    <Button
                      key={amount}
                      variant={
                        formData.amount === amount && !formData.rewardId
                          ? 'default'
                          : 'outline'
                      }
                ...
                <div className='flex gap-2'>
                  <Input
                    ...
                    onChange={e =>
                      handleCustomAmount(parseInt(e.target.value) || 0)
                    }
                    min='1000'
                    className='flex-1'
                  />
                  <span className='self-center text-sm text-gray-500'>원</span>
                </div>
              </div>
            </div>
          </div>
      ...
      case 2:
        return (
          <div className='space-y-6'>
            <div>
              <h3 className='mb-4 text-lg font-semibold'>후원자 정보</h3>
      ...
      case 3:
        return (
          <div className='space-y-6'>
            <div>
              <h3 className='mb-4 text-lg font-semibold'>결제 방법 선택</h3>
      ...
      case 4:
        return (
          <div className='space-y-6'>
            <div>
              <h3 className='mb-4 text-lg font-semibold'>약관 동의 및 확인</h3>

              <div className='space-y-4'>
                {/* 후원 요약 */}
                <div className='rounded-lg bg-gray-50 p-4'>
                  <h4 className='mb-3 font-medium'>후원 요약</h4>
                  <div className='space-y-2 text-sm'>
                    ...
                    {formData.rewardId && (
                      <div className='flex justify-between'>
                        ...
                        <span className='font-medium'>
                          {
                            project.rewards.find(
                              (r: any) => r.id === formData.rewardId,
                            )?.title
                          }
                        </span>
                      </div>
                ...
                <div className='rounded-lg bg-yellow-50 p-4'>
                  <div className='flex items-start gap-2'>
                    ...
                    <div className='text-sm text-yellow-800'>
                      <p className='mb-1 font-medium'>후원 전 확인사항</p>
