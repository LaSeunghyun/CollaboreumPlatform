      ...
      {isLoading ? (
        ...
        <Card className='border-dashed'>
          <CardContent className='space-y-6 p-12 text-center'>
            ...
            <div>
              <h3 className='mb-2 text-xl font-semibold'>커뮤니티 정보를 불러올 수 없습니다</h3>
              <p className='mb-6 text-muted-foreground'>서버에 연결할 수 없습니다. 잠시 후 다시 시도해주세요.</p>
            </div>
            <Button className='bg-green-600 hover:bg-green-700' onClick={onReload}>
        ...
        <Card className='border-dashed'>
          <CardContent className='space-y-6 p-12 text-center'>
            ...
            <div>
              <h3 className='mb-2 text-xl font-semibold'>아직 커뮤니티 글이 없습니다</h3>
              <p className='mb-6 text-muted-foreground'>첫 번째 글을 작성해보세요! 아티스트들과 소통하고 경험을 공유해보세요.</p>
            </div>
            <Button className='bg-green-600 hover:bg-green-700' onClick={onCreatePost}>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
          {posts.slice(0, 4).map(post => {
            ...
            return (
              <Card key={post.id} className='cursor-pointer transition-shadow hover:shadow-md'>
