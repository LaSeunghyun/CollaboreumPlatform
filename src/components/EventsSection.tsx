...
const events = [
  {
    ...
    price: "₩15,000",
    organizer: "홍대음악협회",
    description: "홍대 지역 신진 인디밴드들의 합동 공연으로, 다양한 장르의 음악을 만나볼 수 있습니다.",
  ...
  },
  {
    ...
    price: "무료",
    organizer: "서울시립미술관",
    description: "젊은 작가들의 현대적 시각이 담긴 회화, 조각, 설치 작품들을 전시합니다.",
  ...
  },
  {
    ...
    price: "₩10,000",
    organizer: "문학동네",
    description: "신인 작가들과 함께하는 북토크 시간. 창작 과정과 영감에 대한 이야기를 나눕니다.",
  ...
  },
  {
    ...
    price: "₩20,000",
    organizer: "대학로연극협회",
    description: "신진 연극배우들의 창작극과 즉흥연기를 볼 수 있는 페스티벌입니다.",
  ...
  },
  {
    ...
    price: "₩8,000",
    organizer: "사진작가협회",
    description: "일상의 순간들을 포착한 아마추어 사진작가들의 작품을 만나보세요.",
  ...
  },
  {
    ...
    price: "₩12,000",
    organizer: "청년창작자협회",
    description: "다양한 분야의 청년 창작자들이 만나 네트워킹하고 협업 기회를 모색합니다.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              독립 예술계의 모든 이벤트를 한눈에 확인하고 새로운 영감을 만나보세요
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            ...
            <Button variant="outline" className="md:w-auto rounded-xl">
              ...
              <Card key={event.id} className="group overflow-hidden hover:shadow-apple-lg transition-all duration-300 cursor-pointer border-0 rounded-2xl">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <Badge className="bg-background/90 text-foreground font-medium border-0">
                      {event.price}
                    </Badge>
                  </div>
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center gap-2 text-white">
                      ...
                      <span className="font-medium text-sm">{event.attendees}명 참석 예정</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center">
            <Card className="max-w-2xl mx-auto p-8 glass-morphism rounded-3xl border border-border/30">
