...
const UserMenu: React.FC<UserMenuProps> = ({
  ...
  return (
    <div className='relative' ref={menuRef}>
      ...
      {isOpen && (
        <Card className='absolute right-0 top-full z-50 mt-2 w-64 border-0 shadow-lg'>
            ...
            <div className='border-b border-gray-100 p-4'>
              <div className='flex items-center space-x-3'>
                ...
                <div className='min-w-0 flex-1'>
                  ...
                  <span className='mt-1 inline-block rounded-full bg-primary-100 px-2 py-1 text-xs text-primary-700'>
                    {user.role === 'admin'
                      ? '관리자'
                      : user.role === 'artist'
                        ? '아티스트'
