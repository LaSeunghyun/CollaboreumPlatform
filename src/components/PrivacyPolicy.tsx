        ...
        <div className='mb-8 flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='text-gray-600'>
              Collaboreum의 개인정보 수집 및 이용에 대한 안내입니다
            </p>
          </div>
        </div>
          ...
          <div className='prose prose-lg max-w-none'>
            ...
            <div className='mb-4 space-y-2'>
              ...
              <ul className='ml-4 list-inside list-disc space-y-1 text-gray-700'>
                ...
                <li>
                  서비스 제공: 서비스 공급완료 및 요금결제·정산 완료시까지
                </li>
            ...
            <div className='mb-4 space-y-2'>
              ...
              <p className='text-gray-700'>
                2) 회사는 다음과 같은 경우에 개인정보를 제3자에게 제공할 수
                있습니다:
              </p>
              <ul className='ml-4 list-inside list-disc space-y-1 text-gray-700'>
                ...
                <li>
                  수사목적으로 법령에 정해진 절차와 방법에 따라 수사기관의
                  요구가 있는 경우
                </li>
              </ul>
            </div>
            ...
            <div className='mb-4 space-y-2'>
                ...
                <table className='w-full text-sm'>
                  <thead>
                    <tr className='border-b'>
                      <th className='p-2 text-left'>위탁받는 자 (수탁자)</th>
                      <th className='p-2 text-left'>위탁하는 업무의 내용</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className='border-b'>
              ...
              <p className='text-gray-700'>
                2) 위탁계약 체결시 개인정보 보호법 제26조에 따라 위탁업무
            ...
            <div className='mb-4 space-y-2'>
              ...
              <p className='text-gray-700'>
                2) 개인정보 파기의 절차, 기한 및 방법은 다음과 같습니다.
              </p>
              <ul className='ml-4 list-inside list-disc space-y-1 text-gray-700'>
                <li>
                  파기절차: 불필요한 개인정보 및 개인정보파일은
                  개인정보보호책임자의 승인절차를 거쳐 파기
                </li>
                <li>
                  파기기한: 개인정보의 보유기간이 경과된 경우에는 보유기간의
                  종료일로부터 5일 이내에, 개인정보의 처리목적 달성, 해당
            ...
            <div className='mb-4 space-y-2'>
              <p className='text-gray-700'>
                회사는 개인정보보호법 제29조에 따라 다음과 같은 안전성
                확보조치를 취하고 있습니다.
              </p>
              <ul className='ml-4 list-inside list-disc space-y-1 text-gray-700'>
                <li>
            ...
            <div className='mb-4 space-y-2'>
              ...
              <p className='text-gray-700'>
                2) 정보주체께서는 회사의 서비스를 이용하시면서 발생한 모든
            ...
            <div className='mb-4 space-y-2'>
              ...
              <p className='text-gray-700'>
                2) 이 개인정보처리방침은 2024년 1월 1일부터 적용됩니다.
              </p>
            </div>
            ...
            <div className='mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4'>
              <p className='text-sm text-blue-800'>
                <strong>문의사항</strong>
                <br />
                개인정보 처리방침에 관한 문의사항이 있으시면 언제든지 개인정보
                보호책임자에게 문의해 주시기 바랍니다.
              </p>
            </div>
          </div>
        </div>
