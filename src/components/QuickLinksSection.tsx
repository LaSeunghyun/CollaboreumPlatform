                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {quickLinks.map((link) => {
                        ...
                        return (
                            <Card
                                key={link.id}
                                className="group hover:shadow-lg transition-all duration-300 cursor-pointer border-0 rounded-2xl overflow-hidden bg-gradient-to-br from-background to-secondary/30"
