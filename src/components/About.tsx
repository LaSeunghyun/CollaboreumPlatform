        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-secondary/10 to-muted/20">
            ...
            <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-20">
                    <Card className="text-center p-8 hover:shadow-lg transition-all duration-300 border-border/50 rounded-3xl group">
                ...
                <div className="space-y-20">
                    ...
                    <div className="text-center py-16">
                        ...
                        <Button
                            size="lg"
                            onClick={onBack}
                            className="text-lg px-10 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-2xl shadow-lg transition-all duration-200 hover:scale-105"
                        >
                            플랫폼 둘러보기
