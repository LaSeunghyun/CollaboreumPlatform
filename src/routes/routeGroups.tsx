...
const ArtistsPage = lazy(() =>
  import('@/pages/artists/ArtistsPage').then(module => ({
...
const CommunityPage = lazy(() =>
  import('@/pages/community/CommunityPage').then(module => ({
    default: module.CommunityPage,
  })),
);
const NoticesPage = lazy(() =>
  import('@/pages/notices/NoticesPage').then(module => ({
...
const CreateProjectPage = lazy(() =>
  import('@/pages/projects/CreateProjectPage').then(module => ({
    default: module.CreateProjectPage,
  })),
);
const CreateEventPage = lazy(() =>
  import('@/pages/events/CreateEventPage').then(module => ({
    default: module.CreateEventPage,
  })),
);
const CreateArtworkPage = lazy(() =>
  import('@/pages/gallery/CreateArtworkPage').then(module => ({
    default: module.CreateArtworkPage,
  })),
);
const CreatePostPage = lazy(() =>
  import('@/pages/community/CreatePostPage').then(module => ({
    default: module.CreatePostPage,
  })),
);
const EditPostPage = lazy(() =>
  import('@/pages/community/EditPostPage').then(module => ({
    default: module.EditPostPage,
  })),
);
const ArtistDashboard = lazy(() =>
  import('@/components/ArtistDashboard').then(module => ({
...
const routeGroups: RouteGroup[] = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        component: CommunityPostDetailRoute,
        layout: 'app',
        suspense: false,
      },
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/community-full',
        component: CommunityFullRoute,
        layout: 'app',
        suspense: false,
      },
      {
        path: '/community-main',
        component: CommunityMainRoute,
        layout: 'app',
        suspense: false,
      },
      {
      ...
      {
        path: '/create-post',
        component: CommunityPostFormRoute,
        layout: 'app',
        suspense: false,
      },
