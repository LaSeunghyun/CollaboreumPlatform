...
export function ModalExample() {
  ...
  return (
    <div className='space-y-4'>
      ...
      >
        <ModalHeader>
          <ModalTitle id='small-modal-title'>Confirm Action</ModalTitle>
      ...
      >
        <ModalHeader>
          <ModalTitle id='large-modal-title'>Detailed Information</ModalTitle>
        ...
        <ModalContentWrapper>
          <div className='space-y-4'>
            <p className='text-sm text-muted-foreground'>
              This modal demonstrates the scrollable content area and proper
              focus management.
            </p>
        ...
        <ModalFooter>
          ...
          <Button onClick={() => setOpenLarge(false)}>Save Changes</Button>
        </ModalFooter>
      </Modal>
    </div>
  );
