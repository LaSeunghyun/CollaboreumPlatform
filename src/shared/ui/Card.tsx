...
const cardDescriptionStyles = cva('text-sm text-neutral-500', {
  variants: {
    size: {
      sm: 'text-xs',
      md: 'text-sm',
...
const cardContentStyles = cva('px-6 [&:last-child]:pb-6', {
  variants: {
    size: {
...
const cardFooterStyles = cva('flex items-center px-6 pb-6 [.border-t]:pt-6', {
  variants: {
    size: {
      sm: 'px-3 pt-0',
      md: 'px-6 pt-0',
