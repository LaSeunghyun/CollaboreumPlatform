...
const modalFooterStyles = "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-6 pt-4"
...
const ModalHeader = forwardRef<HTMLDivElement, ModalHeaderProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
            className={cn(modalHeaderStyles, className)}
            {...props}
        />
    )
)
...
const ModalContentWrapper = forwardRef<HTMLDivElement, ModalContentWrapperProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
...
const ModalFooter = forwardRef<HTMLDivElement, ModalFooterProps>(
    ({ className, ...props }, ref) => (
        <div
            ref={ref}
            className={cn(modalFooterStyles, className)}
            {...props}
        />
    )
)
