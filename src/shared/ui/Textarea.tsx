  ...
  'flex min-h-[80px] w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-500 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      ...
      tone: {
        default: '',
        success:
          'border-success-300 focus:ring-success-300 focus:border-success-500',
        warning:
          'border-warning-300 focus:ring-warning-300 focus:border-warning-500',
        danger:
          'border-danger-300 focus:ring-danger-300 focus:border-danger-500',
      },
    },
    defaultVariants: {
      size: 'md',
