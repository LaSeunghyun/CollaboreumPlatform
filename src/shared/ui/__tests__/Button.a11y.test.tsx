...
describe('Button Accessibility Tests', () => {
  it('should have no accessibility violations', async () => {
    const { checkA11y } = renderWithA11y(<Button>Accessible Button</Button>);
  ...
  it('should be focusable and keyboard accessible', async () => {
    const { checkA11y } = renderWithA11y(<Button>Focusable Button</Button>);
  ...
  it('should have proper button role', async () => {
    const { checkA11y } = renderWithA11y(<Button>Button with Role</Button>);
