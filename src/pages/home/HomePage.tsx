                ...
                <section className="text-center space-y-8 md:space-y-12 py-8 md:py-12 relative overflow-hidden min-h-screen flex items-center justify-center">
                    ...
                    <div className="relative z-10 space-y-8 md:space-y-12 px-4">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 max-w-5xl mx-auto pt-8 md:pt-12">
                            <StatCard
                                label="아티스트"
                                value={statsLoading ? "..." : ((platformStats as any)?.data?.totalArtists || defaultStats.totalArtists).toLocaleString()}
                                icon={Users2}
                                iconColor="text-indigo"
                            />
                            <StatCard
                                label="진행 프로젝트"
                                value={statsLoading ? "..." : ((platformStats as any)?.data?.totalProjects || defaultStats.totalProjects).toLocaleString()}
                                icon={TrendingUp}
                                iconColor="text-sky"
                            />
                            <StatCard
                                label="총 후원금액"
                                value={statsLoading ? "..." : `₩${((platformStats as any)?.data?.totalFunding || defaultStats.totalFunding).toLocaleString()}`}
                                icon={Heart}
                    ...
                    {artistsLoading ? (
                        ...
                        <Card className="border-dashed">
                            <CardContent className="p-12 text-center space-y-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold mb-2">아티스트 정보를 불러올 수 없습니다</h3>
                    ...
                    {projectsLoading ? (
                        ...
                        <Card className="border-dashed">
                            <CardContent className="p-12 text-center space-y-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold mb-2">프로젝트 정보를 불러올 수 없습니다</h3>
                                    <p className="text-muted-foreground mb-6">
                                        서버에 연결할 수 없습니다.<br />
                                        잠시 후 다시 시도해주세요.
                                    </p>
                    ...
                    {noticesLoading ? (
                        ...
                        <Card className="border-dashed">
                            <CardContent className="p-12 text-center space-y-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold mb-2">공지사항을 불러올 수 없습니다</h3>
                                    <p className="text-muted-foreground mb-6">
                                        서버에 연결할 수 없습니다.<br />
                                        잠시 후 다시 시도해주세요.
                                    </p>
                        ...
                        return noticeList.length === 0 ? (
                            <Card className="border-dashed">
                                <CardContent className="p-12 text-center space-y-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold mb-2">아직 공지지사항이 없습니다</h3>
                                        <p className="text-muted-foreground mb-6">
                    ...
                    {communityLoading ? (
                        ...
                        <Card className="border-dashed">
                            <CardContent className="p-12 text-center space-y-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold mb-2">커뮤니티 정보를 불러올 수 없습니다</h3>
                                    <p className="text-muted-foreground mb-6">
                                        서버에 연결할 수 없습니다.<br />
                                        잠시 후 다시 시도해주세요.
                                    </p>
                                        ...
                                        <CardContent className="p-4">
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center justify-between text-xs text-muted-foreground">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <span>👍 {typeof post.likes === 'number' ? post.likes : (Array.isArray(post.likes) ? post.likes.length : 0)}</span>
